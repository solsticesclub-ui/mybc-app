...
export default function ReportPage() {
    ...
    return (
      <div className="page">
        ...
        <div className="report-prose">
          ...
          {chapter.view && (
            <button className="report-open-tile" onClick={() => router.push(`/${chapter.view}`)}>
  ...
  return (
    <div className="page">
      <SectionHeader onBack={() => router.push("/hub")} eyebrow="Report" title="What this is" mode={mode} setMode={setMode} />
      <div className="report-prose">
